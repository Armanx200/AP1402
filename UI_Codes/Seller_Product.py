...
# Form implementation generated from reading ui file 'Seller_Product.ui'
#
...
class Ui_Main_Customer(object):
    def setupUi(self, Main_Customer):
        ...
        Main_Customer.setMaximumSize(QtCore.QSize(1280, 1280))
        ...
        self.Main_QW.setGeometry(QtCore.QRect(0, 0, 1231, 1105))
        ...
        self.Item_GL_1.setMaximumSize(QtCore.QSize(9000, 350))
...
"")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../Images/WishList.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Rate.setIcon(icon5)
