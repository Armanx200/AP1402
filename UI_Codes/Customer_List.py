...
# Form implementation generated from reading ui file 'Customer_List.ui'
#
...
class Ui_Main_Customer(object):
    def setupUi(self, Main_Customer):
        ...
        with open('../DataBase/ListOfBuys.pkl', 'rb') as handle:
            self.listofbuys = pickle.load(handle)
        self.listofbuys= [lb for lb in self.listofbuys if lb.Buys[0].Customer.Email == self.c.Email]
        self.tableWidget.setRowCount(len(self.listofbuys))
        for i in range(len(self.listofbuys)):
    ...
    def retranslateUi(self, Main_Customer):
        ...
        # item.setText(_translate("Main_Customer", "a"))
        # item = self.tableWidget.item(0, 1)
        # item.setText(_translate("Main_Customer", "b"))
        # item = self.tableWidget.item(0, 2)
        # item.setText(_translate("Main_Customer", "c"))
        # item = self.tableWidget.item(0, 3)
        # item.setText(_translate("Main_Customer", "d"))
        # item = self.tableWidget.item(0, 4)
        # item.setText(_translate("Main_Customer", "e"))
        # item = self.tableWidget.item(0, 5)
        # item.setText(_translate("Main_Customer", "f"))
...
### Header ###
    ...
    def addbuy(self):
        for i,lb in enumerate(self.listofbuys):
