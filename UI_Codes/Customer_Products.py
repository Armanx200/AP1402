...
class Ui_Main_Customer(object):
    def setupUi(self, Main_Customer):
        ...
        self.Main_QW.setGeometry(QtCore.QRect(0, 0, 989, 766))
        ...
        self.Add_Product()
        self.btn_grp.buttonClicked.connect(self.productbutton)
...
### Header ###
    ...
    def Add_Product(self):
        ...
        for i in range(len(Product_List)):
            ...
            Picture_1.setCheckable(True)
            self.btn_grp.addButton(Picture_1)
    ...
    "")
            ...
            Main_Line = QtWidgets.QFrame(self.Main_QW)
            Main_Line.setFrameShape(QtWidgets.QFrame.HLine)
            Main_Line.setFrameShadow(QtWidgets.QFrame.Sunken)

            Name.setText(str(Product_List[i].Name))
            Name.setStyleSheet("font-size:12pt;background-color:rgb(0,0,0,0)")
            Rate.setText(f"{Product_List[i].Rating} / 5")

    def productbutton(self, btn):
        
        from Customer_Product import Ui_Main_Customer
        self.Page = QtWidgets.QWidget()
        self.ui = Ui_Main_Customer()
        self.ui.setupUi(self.Page,self.p[-1*(self.btn_grp.checkedId()+1)-1])
