...
# Form implementation generated from reading ui file 'Customer_WishList.ui'
#
...
class Ui_Main_Customer(object):
    def setupUi(self, Main_Customer):
        ...
        self.Main_QW.setGeometry(QtCore.QRect(0, -243, 989, 809))
...
"")
        ...
        self.toolButton_2 = QtWidgets.QToolButton(self.Item_GL_2)
        icon5 = QtGui.QIcon()
        ...
        self.gridLayout_8.addWidget(self.toolButton_2, 0, 0, 1, 1, QtCore.Qt.AlignTop)
        self.gridLayout.addWidget(self.Item_GL_2, 4, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.Main_Line, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Main_Line_3, 6, 0, 1, 1)
...
"")
        ...
        self.gridLayout_2.addWidget(self.toolButton, 0, 0, 1, 1, QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, Main_Customer):
        ...
        self.toolButton_2.setText(_translate("Main_Customer", "حذف"))
        ...
        self.label.setText(_translate("Main_Customer", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600;\">لیست علاقه مندیها</span></p></body></html>"))
