...
class Ui_Main_Customer(object):
    def setupUi(self, Main_Customer):
        ...
        self.Main_QW.setGeometry(QtCore.QRect(0, 0, 989, 809))
        ...
        self.btn_grp.buttonClicked.connect(self.delbutton)
        ...
        self.verticalLayout_3.addWidget(self.Main_Line_3)
    ...
    def retranslateUi(self, Main_Customer):
        ...
        Main_Customer.setWindowTitle(_translate("Main_Customer", "WhishList"))
...
### Header ###
    ...
    def add_to_wishlist(self):
        ...
        for Wish in self.c.Wishlist:
            ...
            Item_GL_1.setMinimumSize(QtCore.QSize(900, 350))
    ...
    "")
            ...
            gridLayout_2.addWidget(Description, 1, 1, 1, 1)
            ...
            gridLayout_2.addWidget(toolButton, 0, 0, 1, 1, QtCore.Qt.AlignTop)
            self.verticalLayout_3.addWidget(Item_GL_1)

            Name.setText(Wish.Name)
            Rate.setText(f"{Wish.Rating} / 5")
            toolButton.setText("حذف")

    def delbutton(self, btn):
        del self.c.Wishlist[-1*(self.btn_grp.checkedId()+1)-1]
